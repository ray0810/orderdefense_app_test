...
const Index = () => {
  ...
  const [
    injectScript,
    {
      loading: injectScriptLoading,
      data: injectScriptFile,
    },
      ...
      await createProduct({
        variables: {
          input: {
            ...
            vendor: "OrderDefense",
            images: [{ src: "https://orderdefense.com/wp-content/uploads/2021/02/orderdefense-icon.jpg" }],
            options: ["Price"],
            variants: [
              {
                price: "0.95",
          ...
          <Layout.Section>
            <Card>
              <SettingToggle
                ...
                enabled={active}
              >
                OrderDefense is <TextStyle variation="strong">{textStatus}</TextStyle>. (This doesn't work)
              </SettingToggle>
            </Card>
            <Card sectioned>
              <FormLayout>
                <Heading>OrderDefense Product Installation</Heading>
                  ...
                  <TextContainer>
                    <p>
                      Click the button below to create the OrderDefense product on your store.
                    </p>
                  </TextContainer>
                <Button
                  size="medium"
                  primary={true}
                  onClick={onSubmitMutation}
                >
                  Create OrderDefense Product
            ...
            <Card sectioned>
              <FormLayout>
                <Heading>OrderDefense Script Installation</Heading>
                  ...
                  <TextContainer>
                    <p>
                      Click the button below to install the OrderDefense script on your store.
                    </p>
                  </TextContainer>
                <Button
                  size="medium"
                  primary={true}
                  onClick={onSubmitInject}
                >
                  Install OrderDefense Script
                  {injectScriptLoading && (
                    <Spinner
                      accessibilityLabel="Spinner example"
                      size="small"
            ...
            <Card sectioned>
              <FormLayout>
                <Heading>Delete Scripts (This doesn't work)</Heading>
                  ...
                  <TextContainer>
                    <p>
                      Delete scripts installed on the store.
                    </p>
                  </TextContainer>
                <Button
                  size="medium"
